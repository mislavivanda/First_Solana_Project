    ...
    if (status === "authenticated") {
      const fetchData = async () => {
        try {
          ...
          setPostData({
            content: `Ciro Immobile has made history and became S.S. Lazio’s undisputed best scorer with his 160th goal scored in the UEFA Europa League match against Marseille, on the 4th November, 2021—surpassing previous record holder and football legend, Silvio Piola.
